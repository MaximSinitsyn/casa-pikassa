...
if($_POST['data']) {
    ...
    try {
        ...
        $text .= "Город клиента: <b>" . $city_client . "</b><br>";
        ...
        $m->To( "a.bychkov@kvott.ru" ); // кому адресованно
        ...
        $m->smtp_on("ssl://smtp.yandex.ru", "ragnoras@yandex.ru", "Master1990magic" , 465) ; // если указана эта команда, отправка пойдет через SMTP  //ssl://
